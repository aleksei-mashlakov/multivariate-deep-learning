...
if __name__ == '__main__':
    ...
    val_out_file = os.path.join('./save', 'val_results_power_full.csv')
    test_out_file = os.path.join('./save', 'test_results_power_full.csv')
    ...
    while max_evals <= 150:
        ...
        search_params = {'dropout': hp.quniform('dropout', 0.1, 0.5, 0.1),
                         ...
                         'window': hp.choice('window', [48, 72, 128, 168])}
