...
#!/bin/bash
#SBATCH --job-name=deepar_train_power12_3
...
#SBATCH --output=job_out_elect_power_evaluate_12.txt
#SBATCH --error=job_err_elect_power_evaluate_12.txt
...
#                  --dataset='elect' \
#                  --data-folder='power_system_12' \
#                  --model-name='power_system_12' \
#                  --restore-file='epoch_63'
