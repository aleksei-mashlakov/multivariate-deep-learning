...
#SBATCH --output=job_out_power36_solar.txt
#SBATCH --error=job_err_power36_solar.txt
...
python3 preprocess_power_system.py --dataset='elect' \
                                   --data-folder='data' \
                                   --model-name='power_system_solar_36' \
...
python3 train.py --sampling \
                 --dataset='elect' \
                 --data-folder='power_system_solar_36' \
                 --model-name='power_system_solar_36'
