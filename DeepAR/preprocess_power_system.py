...
parser.add_argument('--model-name', default='power_system_24', help='Directory containing params.json')
parser.add_argument('--file-name', default='europe_power_system.csv', help='Directory containing data.csv')
...
parser.add_argument('--num_covariates', default=4, type=int, help='Choose the number of exogeneous variables') 
...
def gen_covariates(times, num_covariates):
    ...
    print('covariates', covariates[:, :num_covariates])
...
#         stride_size = 24
    ...
    if not args.test:
        ...
        test_start = '2017-01-09 00:00:00' #need additional 7 days as given info
        test_end = '2017-06-23 23:00:00'
    else:
        train_start = '2015-01-01 00:00:00'
        train_end = '2017-01-15 23:00:00'
    ...
    if args.hop:
        train_start = '2015-01-01 00:00:00'
        train_end = '2015-04-30 23:00:00' #'2014-06-30 23:00:00'
        test_start = '2015-04-24 00:00:00' #need additional 7 days as given info  '2014-06-24 00:00:00'
        test_end = '2015-05-31 23:00:00' #2014-12-28
...
#                 zfile.extractall(save_path)
    ...
    #data_frame = data_frame.loc[:,[column for column in data_frame.columns if ('price' in column) or ('forecast' in column)]] #'load_actual'
    #
    #data_frame = data_frame.iloc[:,[i for i in range(40)]]
    #
