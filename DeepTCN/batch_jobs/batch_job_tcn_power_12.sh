...
#SBATCH --output=job_out_power_12_3.txt
#SBATCH --error=job_err_power_12_3.txt
...
python3 ec_feature_preprocess.py --data-folder='data' \
                                 ...
                                 --pickle-name='power_system_12_3.pkl' \
                                 --horizon=12
echo "Data loaded."

echo "Start running ... "
python3 ec_probabilistic_forecasting.py --data-folder='data' \
                                        --model-name='power_12_3.pkl' \
                                        --pickle-name='power_system_12_3.pkl' \
                                        --dim=183 \
                                        --horizon=12 \
                                        --patience=25 \
