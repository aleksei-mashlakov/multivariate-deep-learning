#!/bin/bash
#SBATCH --job-name=tcn_p_solar_36
...
#SBATCH --output=job_out_power_solar_36_new.txt
#SBATCH --error=job_err_power_solar_36_new.txt
...
python3 ec_feature_preprocess.py --data-folder='data' \
                                 --file-name='europe_power_system_solar.csv' \
                                 --pickle-name='power_system_solar_36.pkl' \
                                 --horizon=36
echo "Data loaded."

echo "Start running ... "
python3 ec_probabilistic_forecasting.py --data-folder='data' \
                                        --model-name='power_solar_36.pkl' \
                                        --pickle-name='power_system_solar_36.pkl' \
                                        --dim=36 \
                                        --horizon=36 \
                                        --patience=25 \
