...
Please cite the following paper if you use the dataset or source code:
...
The datasets are under [datasets](datasets) folder. To run the codes, please locate the datasets in the corresponding data folder of the model repository.
...
The dataset corresponds to [Time Series data package](https://data.open-power-system-data.org/time_series/2019-06-05) with the [documentation](https://nbviewer.jupyter.org/github/Open-Power-System-Data/datapackage_timeseries/blob/2019-05-15/main.ipynb).
